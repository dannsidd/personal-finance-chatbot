...
Contains all AI and financial analysis services using IBM Granite from HuggingFace
"""
...
SERVICES = {
    "granite_huggingface": granite_huggingface_service,
